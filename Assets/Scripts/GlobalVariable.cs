...
public class GameData
{
    ...
    // 진행 중인 선택
    public int savedStageFlatIndex;          // 진행 중이던 (chapter, stage)의 통합 인덱스
    public bool hasPendingRun;               // 진행 중 플래그

    // 인벤토리 선택(아이템) – ScriptableObject를 직접 저장하지 말고 ID만 저장
...
public class GlobalVariable : MonoBehaviour
{
    ...
    // 진행 중인 스테이지
    public int SavedStageFlatIndex = -1;   // 없으면 -1
    ...
    public int ShopCoin = 0; // 소모품 상점에서 사용할 코인
